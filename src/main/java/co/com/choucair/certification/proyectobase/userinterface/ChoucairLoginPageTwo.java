...
public class ChoucairLoginPageTwo extends PageObject{
    ...
    public static final Target COUNTRY = Target.the("Select the operating system").
    ...
    public static final Target COUNTRY_LABEL = Target.the("Choose the operating system").
